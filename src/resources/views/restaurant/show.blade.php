...
<div class="container px-5 py-24 mx-auto flex justify-center">
    <div class="lg:w-3/5 md:w-1/2 bg-white rounded-lg p-8 w-full mt-10 md:mt-0 relative z-10 shadow-md">
        <div class="container">
            <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">投稿一覧</h2>
        ...
        <div class="container mt-5">
            ...
            <form method="POST" action="{{ route('restaurant.reviews.store', $restaurant) }}" onSubmit="return checkSubmit()">
                ...
                <div class="form-group">
                    <label class="block text-gray-500 font-bold  mb-1 md:mb-0 pr-4" for="comment">
                    ご意見
                    </label>
                ...
                <label class="block text-gray-500 font-bold  mb-1 md:mb-0 pr-4" for="gender">性別</label>
                ...
                <label class="block text-gray-500 font-bold  mb-1 md:mb-0 pr-4" for="age">年代</label>
                ...
                <label class="block text-gray-500 font-bold  mb-1 md:mb-0 pr-4" for="star">評価</label>
